...
{
    public static class GenDllMeta
    {
        ...
        {
            string metaText = GenDllMeta.EditorDllMeta();
        ...
        {
            string metaText = GenDllMeta.AndroidDllMeta();
        ...
        {
            string metaText = GenDllMeta.iOSDllMeta();
        ...
        {
            string metaText = GenDllMeta.Win64DllMeta();
        ...
        {
            string metaText = GenDllMeta.WebglDllMeta();
        ...
        {
            string metaText = GenDllMeta.AnyDllMeta();
        ...
        {
            string metaText = GenDllMeta.FileMeta();
        ...
        {
            string metaText = GenDllMeta.FolderMeta();
        ...
        public static void TargetMetaFileGen(string metaDesPath, BuildTarget target)
        {
            ...
            switch (target)
            {
                case BuildTarget.Android:
                    metaText = GenDllMeta.AndroidDllMeta();
                    break;
                case BuildTarget.iOS:
                    metaText = GenDllMeta.iOSDllMeta();
                    break;
                case BuildTarget.StandaloneWindows:
                case BuildTarget.StandaloneWindows64:
                    metaText = GenDllMeta.Win64DllMeta();
                    break;
                case BuildTarget.WebGL:
                    metaText = GenDllMeta.WebglDllMeta();
                    break;
            }
