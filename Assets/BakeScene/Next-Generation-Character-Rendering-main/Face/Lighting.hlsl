...
CusomLightingData CalculateLightingData(VertexOutput vertexOutput, float3 sampledNormal, float3 direction)
{
...
float DiffuseTerm(CusomLightingData lightingData)
{
