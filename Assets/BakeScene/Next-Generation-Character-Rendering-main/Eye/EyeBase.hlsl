...
float DiffuseTerm(VertexOutput vertexOutput, CusomLightingData lightingData)
{
...
float4 Frag(VertexOutput vertexOutput) : SV_Target
{
    ...
    CusomLightingData lightingData = CalculateLightingData(vertexOutput, eyeWorldNormal, _MainLightPosition.xyz);
