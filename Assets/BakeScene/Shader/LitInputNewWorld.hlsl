#ifndef UNIVERSAL_LIT_INPUT_INCLUDED_NEW_WORLD
#define UNIVERSAL_LIT_INPUT_INCLUDED_NEW_WORLD
...
//添加的参数
half _MainLightHeight;
half _BackSpecularIntension;
half _BackSpecularRange;
half _BackSpecularNormal;
half _MatCapMapStrength;
half _MatCapMap2Strength;
half _MatCapSpecularHeight;
half _MatCapMapShadowStrength;
half4 _MatCapMapColor;
half4 _MatCapMapShadowColor;
CBUFFER_END
