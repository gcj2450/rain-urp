...
namespace MyGraphics.Editor.ObjectEffect.Iridescence
{
    public static class IridescenceGUIProperties
    {
        ...
        public struct IridescenceProperties
        {
            ...
            public IridescenceProperties(MaterialProperty[] properties)
            {
                ...
                iridescenceEta2 = BaseShaderGUI.FindProperty("_IridescenceEta2", properties, false);
                iridescenceEta3 = BaseShaderGUI.FindProperty("_IridescenceEta3", properties, false);
                iridescenceKappa3 = BaseShaderGUI.FindProperty("_IridescenceKappa3", properties, false);
            }
        }
