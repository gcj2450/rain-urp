Shader "CustomURP/Base/PBR_WIDGETS"
{
    Properties
    {
...
//        _EmissionMap ("Emission", 2D) = "white" { }
        ...
        [Toggle(_BREATHING_ON)] _Breathing("呼吸灯", float) = 0
//        [HDR] _BreathingColor ("呼吸灯Color", Color) = (0, 0, 0)
        [HDR] _BreathingTime ("呼吸灯速度", range(0.01, 5)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature  _DITHER_OPEN
